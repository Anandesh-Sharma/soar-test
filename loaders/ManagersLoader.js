...
const Sample                = require('../managers/users/Users.Manager');
const School                = require('../managers/controllers/school.manager');
const Classroom             = require('../managers/controllers/classroom.manager');
const Student               = require('../managers/controllers/student.manager');
const User                  = require('../managers/controllers/user.manager');   
/** 
